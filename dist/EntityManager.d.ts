 ...
 */
export declare function make<R, Req>(layerScope: Scope.Scope, recipientType: RecipientType.RecipientType<Req>, behaviour_: RecipientType.RecipientBehaviour<R, Req>, sharding: Sharding.Sharding, config: ShardingConfig.ShardingConfig, messageQueue: MessageQueue.MessageQueue, entityMaxIdle: Option.Option<Duration.Duration>): Effect.Effect<R, never, EntityManager<Req>>;
