 ...
 */
export declare function make<R, Req>(layerScope: Scope.Scope, recipientType: RecipientType.RecipientType<Req>, recipientBehaviour: RecipientBehaviour.RecipientBehaviour<R, Req>, sharding: Sharding.Sharding, config: ShardingConfig.ShardingConfig, entityMaxIdle: Option.Option<Duration.Duration>): Effect.Effect<R, never, EntityManager<Req>>;
