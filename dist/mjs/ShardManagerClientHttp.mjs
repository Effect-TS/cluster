 ...
 * @category layers
 */
export const shardManagerClientHttp = /*#__PURE__*/Layer.effect(ShardManagerClient.ShardManagerClient, /*#__PURE__*/pipe(ShardingConfig.ShardingConfig, /*#__PURE__*/Effect.map(config => ({
  ...
  getAssignments: pipe(send(ShardManagerProtocolHttp.GetAssignments_, ShardManagerProtocolHttp.GetAssignmentsResult_)(config.shardManagerUri, {
    _tag: "GetAssignments"
