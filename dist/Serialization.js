 ...
 * @category symbols
 */
const TypeId = /*#__PURE__*/Symbol.for("@effect/sharding/SerializationTypeId");
/**
 * @since 1.0.0
 * @category context
 */
...
const json = /*#__PURE__*/Layer.succeed(Serialization, {
  _id: TypeId,
  encode: (message, schema) => Effect.map(ByteArray.make)((0, _utils.jsonStringify)(message, schema)),
  decode: (body, schema) => (0, _utils.jsonParse)(body.value, schema)
});
exports.json = json;
