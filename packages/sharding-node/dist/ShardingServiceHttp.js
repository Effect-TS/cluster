...
const shardingServiceHttp = /*#__PURE__*/Layer.scopedDiscard(Effect.gen(function* (_) {
  ...
  return yield* _(Http.router.empty.pipe(Http.router.post("/assign-shards", Effect.gen(function* (_) {
    ...
    const result = (0, _Function.pipe)(sharding.sendToLocalEntityStreamingReply(body.message), Stream.map(_ => Either.right(_)), Stream.catchAll(e => Stream.succeed(Either.left(e))), Stream.mapEffect(_ => (0, _utils.jsonStringify)(_, ShardingProtocolHttp.SendStreamResultItem_)), (0, _utils.uint8ArrayFromStringStream)());
