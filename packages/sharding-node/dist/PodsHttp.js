...
const httpPods = /*#__PURE__*/Layer.effect(Pods.Pods, /*#__PURE__*/Effect.gen(function* (_) {
  ...
  function sendMessageStreaming(podAddress, binaryMessage) {
    return Effect.gen(function* (_) {
      ...
      return (0, _Function.pipe)(response, (0, _utils.stringFromUint8ArrayString)("utf-8"), Stream.splitLines, Stream.mapEffect(_ => (0, _utils.jsonParse)(_, ShardingProtocolHttp.SendStreamResultItem_)));
