...
export interface Pods {
     ...
     * @since 1.0.0
     */
    readonly sendMessage: (pod: PodAddress.PodAddress, message: BinaryMessage.BinaryMessage) => Effect.Effect<never, ShardingError.ShardingError, Option.Option<ByteArray.ByteArray>>;
    /**
     * Send a message to a pod and receive a stream of replies
     * @since 1.0.0
     */
    readonly sendMessageStreaming: (pod: PodAddress.PodAddress, message: BinaryMessage.BinaryMessage) => Stream.Stream<never, ShardingError.ShardingError, ByteArray.ByteArray>;
}
/**
 * @since 1.0.0
 * @category context
