...
export interface Serialization {
     ...
     * @since 1.0.0
     */
    readonly encode: <I, A>(message: A, schema: Schema.Schema<I, A>) => Effect.Effect<never, ShardingError.ShardingErrorSerialization, ByteArray.ByteArray>;
    /**
     * Transform binary back into the given type
     * @since 1.0.0
     */
    readonly decode: <I, A>(bytes: ByteArray.ByteArray, schema: Schema.Schema<I, A>) => Effect.Effect<never, ShardingError.ShardingErrorSerialization, A>;
}
/**
 * @since 1.0.0
 * @category context
