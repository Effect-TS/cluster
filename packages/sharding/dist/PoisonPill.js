 ...
 * @category symbols
 */
const TypeId = "@effect/sharding/PoisonPill";
/**
 * `PoisonPill`
 *
 * @since 1.0.0
...
function takeOrInterrupt(dequeue) {
  return (0, _Function.pipe)(Queue.take(dequeue), Effect.flatMap(msg => isPoisonPill(msg) ? Effect.interrupt : Effect.succeed(msg)));
}
