 ...
 * @category models
 */
export interface EntityState<Msg extends Message.Message> {
...
/** @internal */
export function make<Msg extends Message.Message>(
...
): <Msg extends Message.Message>(entityState: EntityState<Msg>) => EntityState<Msg> {
