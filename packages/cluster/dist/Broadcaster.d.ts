...
export interface Broadcaster<Msg> {
     ...
     * @since 1.0.0
     */
    readonly broadcast: (topic: string) => <A extends Msg & Message.Message<any>>(msg: A) => Effect.Effect<never, ShardingError.ShardingError, HashMap.HashMap<PodAddress.PodAddress, Either.Either<ShardingError.ShardingError, Message.Success<A>>>>;
}
