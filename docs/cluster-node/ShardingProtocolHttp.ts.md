...
export declare const SendResult_: Schema.Schema<
  ...
  | {
      ...
      readonly right:
        ...
        | {
            readonly _tag: 'Some'
            readonly value: { readonly _id: '@effect/cluster/SerializedMessage'; readonly value: string }
          }
    },
  Either<
    ...
    Option<Data<{ readonly _id: '@effect/cluster/SerializedMessage'; readonly value: string }>>
  >
>
```
...
export declare const Send_: Schema.Schema<
  ...
  },
  {
    readonly message: Data<{
      ...
      readonly entityId: string
      readonly entityType: string
      readonly body: Data<{ readonly _id: '@effect/cluster/SerializedMessage'; readonly value: string }>
