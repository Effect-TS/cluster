...
```ts
export type ShardingException = Schema.Schema.To<typeof schema>
```
...
export declare const schema: Schema.Schema<
  ...
  | { readonly _tag: "@effect/cluster/EntityNotManagedByThisPodException"; readonly entityId: string }
  | { [x: string]: unknown; readonly _tag: "@effect/cluster/EntityTypeNotRegisteredException" }
  | { readonly _tag: "@effect/cluster/NoResultInProcessedMessageStateException" }
  | { [x: string]: any; readonly _tag: "@effect/cluster/PodNoLongerRegisteredException" }
  | { [x: string]: any; readonly _tag: "@effect/cluster/PodUnavailableException" }
  | { readonly _tag: "@effect/cluster/SendTimeoutException" }
  | { readonly _tag: "@effect/cluster/SerializationException" }
  | { readonly _tag: "@effect/cluster/ExceptionWhileOfferingMessageException" },
  any
>
```
